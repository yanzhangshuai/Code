...
namespace Demo1.ObjectExtending
{
    public static class Demo1DomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the Demo1EfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
